...
const TIPS: { keys?: string; text: string }[] = [
  ...
  { text: "No wifi? Cached pages open instantly anyway — and your edits queue and sync when you're back. Notion web is a white screen." },
  { text: "⌘T → “While you were away” shows every watched doc that changed since you last read it, with what changed." },
  { text: "Paste a bare Notion URL into a doc — it turns into a titled link automatically." },
  { text: "Every page shows “Linked from” — the docs that reference it, computed locally from your cache." },
  { text: "Hive lives in your menu bar too — capture or check for updates without the dock." },
